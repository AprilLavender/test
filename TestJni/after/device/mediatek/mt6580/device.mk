...
PRODUCT_PACKAGES += consumerir.mt6580
endif
...
PRODUCT_PACKAGES += libHEVCdec_sa.ca7.android_2core
...
PRODUCT_PACKAGES += libvp9dec_sa.ca7_2core
...
#PRODUCT_PACKAGES += Videos ROCO_ShiYouHui remove @ 2015-11-24
PRODUCT_PACKAGES += sn
...
#ROCO Jerry.He modify for items begin
PRODUCT_PACKAGES += libitems
#ROCO Jerry.He modify for items end
...
# ROCO_ShiYouHui add for custom override Apns-conf.xml configurations  @2015-10-08 >>>
ifneq ($(strip $(ROCO_PROJECT)),)
	ifneq ($(wildcard $(MTK_PROJECT_FOLDER)/roco/$(ROCO_PROJECT)/apns-conf.xml),)
		PRODUCT_COPY_FILES += $(MTK_PROJECT_FOLDER)/roco/$(ROCO_PROJECT)/apns-conf.xml:system/etc/apns-conf.xml
	else
